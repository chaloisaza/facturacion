...
<div class="container">
                        ...
                        <div class="uploadExcelFields panel-body">
                            ...
                            <form enctype="multipart/form-data" action="" method="post">
                                ...
                                <div class"row">
                                    ...
                                    <div class="paddingInput col-sm-11"><input id="nameInput" name="nameInput" type="text" value=""></div>
                                </div>

                                <div class"row">
                                    <div class="paddingInput col-sm-1"><label for="nitInput">NIT:</label></div>
                                    <div class="paddingInput col-sm-11"><input id="nitInput" name="nitInput" type="text" value=""></div>
                                </div>

                                <div class"row">
                                    <div class="paddingInput col-sm-1"><label for="porcentajeInteresInput">Interés:</label></div>
                                    <div class="paddingInput col-sm-11"><input id="porcentajeInteresInput" name="porcentajeInteresInput" type="text" value=""></div>
                                </div>
                                
                                <div class"row">
                                    <div class="paddingInput col-sm-1"><label for="bancoRecaudoInput">Banco:</label></div>
                                    <div class="paddingInput col-sm-11"><input id="bancoRecaudoInput" name="bancoRecaudoInput" type="text" value=""></div>
                                </div>
                                
                                <div class"row">
                                    <div class="paddingInput col-sm-1"><label for="mensajeInput">Mensaje:</label></div>
                                    <div class="paddingInput col-sm-11"><textarea id="mensajeInput" name="mensajeInput" cols="30" rows="10" ></textarea></div>
                                </div>
    ...
    <?php  
        ...
        if (isset($_POST['saveChanges'])) {
            ...
            $resultUpload = insertUnidad($_POST['nameInput'], $_POST['nitInput'], $_POST['porcentajeInteresInput'],  $_POST['bancoRecaudoInput'], $_POST['mensajeInput']);

            if($resultUpload > 0){
                if ((!empty($_FILES["imagenUnidadInput"])) && ($_FILES['imagenUnidadInput']['error'] == 0)) {
                    $filename = $resultUpload;
                    $pathSave = 'unidadImages\\' .$filename . '.png';
        ...
        function alertInformation($var){
            ...
            if ($var == true) {
                successAlert("Se agregó la unidad correctamente");
            } else {
                errorAlert();
            }
        }
